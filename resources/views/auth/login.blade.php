<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="relative mt-6">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="bg-playdf-card px-3 text-gray-400">o continúa con</span>
            </div>
        </div>

        {{-- ═══════════════════════════════════════════════════ --}}
        {{-- BOTÓN GOOGLE SIGN-IN (Firebase JS SDK) --}}
        {{-- Icono: Tabler Icons BrandGoogle (MIT) --}}
        {{-- ═══════════════════════════════════════════════════ --}}
        <div class="mt-6">
    ...
    <script type="module">
        ...
        // Configuración dinámica desde el backend de Laravel (.env)
        ...
        btnGoogle.addEventListener('click', async () => {
            ...
            try {
                ...
                // Enviar el token a Laravel para crear/iniciar sesión
